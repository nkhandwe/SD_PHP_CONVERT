  ...
  <body>
    ...
    <div class="page">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="#">Services</a>
                        ...
                        <ul class="rd-menu rd-navbar-dropdown">
                          <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="single-service.php">Single Service</a></li>
                        </ul>
                      </li>
      ...
      <section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(images/breadcrumbs-bg.jpg);">
        <div class="container">
          <h4 class="breadcrumbs-custom-title">Single Service</h4>
          ...
          <div class="row row-30">
            <div class="col-md-5 col-lg-4">
              <div class="section-title section-title-left">
                <h2 class="text-capitalize">Family Law <br>Service</h2>
              </div>
            </div>
            <div class="col-md-7 col-lg-8 pt-md-5">
              <p>In today’s challenging economic climate, our clients demand advice which is efficient, effective and assists them in navigating the often complicated legal and regulatory requirements associated with financial transactions.Our team advises clearing and private banks, building societies, specialist lenders and borrowers (both corporate and individual) on all aspects of lending transactions and related issues across a broad range of sectors, including large-scale residential and commercial development projects and leisure and sporting facilities.</p><img src="images/single-service-1-770x274.jpg" alt="" width="770" height="274"/>
              <p>We advise on all types of finance arrangements including loan agreements, invoice discounting arrangements, asset finance and finance leasing. We also advise on all types of security structures.</p>
              <p>Whether a transaction involves the acquisition or refinancing of property, a business or a portfolio of mixed assets, our team has the expertise and experience to deliver a positive result.</p>
              <p>We add value by providing realistic and commercial solutions to the challenges faced by our clients. Our integrated approach to legal services allows our team to draw on the sector-focussed expertise of other lawyers across the firm to deliver informed advice on complex issues.</p>
            </div>
          </div>
        </div>
      </section>
              ...
              <div class="card-group-custom card-group-minimal" id="accordion1" role="tablist" aria-multiselectable="false">
                ...
                <article class="card card-custom card-corporate card-minimal">
                  <div class="card-header" role="tab">
                    <div class="card-title"><a class="heading-4" id="accordion1-card-head-oprhxhhy" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-nwmkayks" aria-controls="accordion1-card-body-nwmkayks" aria-expanded="true" role="button">Insurance Defence
                        <div class="card-arrow"></div></a></div>
                  </div>
                  <div class="collapse show" id="accordion1-card-body-nwmkayks" aria-labelledby="accordion1-card-head-oprhxhhy" data-parent="#accordion1" role="tabpanel">
                    <div class="card-body">
                ...
                <article class="card card-custom card-corporate card-minimal">
                  <div class="card-header" role="tab">
                    <div class="card-title"><a class="heading-4 collapsed" id="accordion1-card-head-ogwttraq" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-dupstcte" aria-controls="accordion1-card-body-dupstcte" aria-expanded="false" role="button">Land&amp;Asset
                        <div class="card-arrow"></div></a></div>
                  </div>
                  <div class="collapse" id="accordion1-card-body-dupstcte" aria-labelledby="accordion1-card-head-ogwttraq" data-parent="#accordion1" role="tabpanel">
                    <div class="card-body">
                      <p>Professional help with financial, commercial, tax disputes and other complex business issues.</p>
                    </div>
                  </div>
                ...
                <article class="card card-custom card-corporate card-minimal">
                  <div class="card-header" role="tab">
                    <div class="card-title"><a class="heading-4 collapsed" id="accordion1-card-head-xpgvtcdb" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-ujrtvcfs" aria-controls="accordion1-card-body-ujrtvcfs" aria-expanded="false" role="button">Finance Law
                        <div class="card-arrow"></div></a></div>
                  </div>
                  <div class="collapse" id="accordion1-card-body-ujrtvcfs" aria-labelledby="accordion1-card-head-xpgvtcdb" data-parent="#accordion1" role="tabpanel">
                    <div class="card-body">
                      <p>Your civil rights will be defended and represented on the highest level with the best outcome.</p>
                    </div>
                  </div>
