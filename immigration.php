  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(images/breadcrumbs-bg.jpg);">
        <div class="container">
          <h4 class="breadcrumbs-custom-title">Immigration</h4>
          ...
          <div class="row row-30">
            <div class="col-md-5 col-lg-4">
              <div class="section-title section-title-left">
                <h2 class="text-capitalize">Immigration <br>Service</h2>
              </div>
            </div>
            <div class="col-md-7 col-lg-8 pt-md-5">
              <p>Immigrating to Canada can be a complex process, involving a variety of different immigration services and requirements for permanent residence. Those who may be facing immigration challenges or need assistance with immigration refusals or appeals can work with an experienced immigration specialist to navigate the system and get the help they need. With expert guidance, individuals can more easily understand their immigration options and pursue pathways that are best suited to their personal situation. Whether you are applying on your own behalf or seeking immigration as the spouse of a permanent resident, working with an immigration specialist will ensure that you have the support and knowledge you need to succeed. So if you are looking to immigrate to Canada, consider contacting us today so you can start your journey towards a better future.</p><img src="images/single-service-1-770x274.jpg" alt="" width="770" height="274"/>
              <p></p>
            </div>
          </div>
        </div>
