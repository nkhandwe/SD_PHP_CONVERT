...
<html class="wide wow-animation" lang="en">
  <head>
    <title>Notary and attestation</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(images/breadcrumbs-bg.jpg);">
        <div class="container">
          <h4 class="breadcrumbs-custom-title">Notary and attestation</h4>
          ...
          <div class="row row-30">
            <div class="col-md-5 col-lg-4">
              <div class="section-title section-title-left">
                <h2 class="text-capitalize">Notary and attestation <br>Service</h2>
              </div>
            </div>
            <div class="col-md-7 col-lg-8 pt-md-5">
              <p>A notary is a person who is authorized by the government to witness the signing of important documents and to make them official. An attestation is a statement or declaration by a notary that a document is genuine. 
<br>
                We provide these services .</p><img src="images/single-service-1-770x274.jpg" alt="" width="770" height="274"/>
              <p></p>
            </div>
          </div>
        </div>
