          ...
          <div class="block-icon-modern-items">
            <div class="block-icon-modern block-icon-primary">
              ...
              <div class="block-icon-caption">
                <h4 class="block-icon-title"><a href="single-service.html">Helping Business</a></h4>
            ...
            <div class="block-icon-modern block-icon-secondary">
              ...
              <div class="block-icon-caption">
                <h4 class="block-icon-title"><a href="single-service.html">Consulting Individuals</a></h4>
            ...
            <div class="block-icon-modern block-icon-secondary">
              ...
              <div class="block-icon-caption">
                <h4 class="block-icon-title"><a href="single-service.html">Solving Insurance Claims</a></h4>
...
<a href="realestate.html">Read More...</a>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="block-icon-modern">
                <div class="icon-figure"><span class="icon icon-xl thin-icon-briefcase-2"></span></div>
                <div class="block-icon-caption">
                  <h4 class="block-icon-title"><a href="immigration.html">Immigration</a></h4>
...
<a href="immigration.html">Read More...</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-4">
              <div class="block-icon-modern">
                ...
                <div class="block-icon-caption">
                  <h4 class="block-icon-title"><a href="familylaw.html">Family Law</a></h4>
...
<a href="familylaw.html">Read More...</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-4">
              <div class="block-icon-modern">
                <div class="icon-figure"><span class="icon icon-xl thin-icon-umbrella"></span></div>
                <div class="block-icon-caption">
                  <h4 class="block-icon-title"><a href="personalinjury.html">Personal injury</a></h4>
...
<a href="personalinjury.html">Read More...</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-4">
              <div class="block-icon-modern">
                ...
                <div class="block-icon-caption">
                  <h4 class="block-icon-title"><a href="willsandestate.html">Wills and estate</a></h4>
                  <p>A will is a legally binding document that dictates how your assets will be distributed after your death.</p>
                  
<a href="willsandestate.html">Read More...</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-4">
              <div class="block-icon-modern">
                ...
                <div class="block-icon-caption">
                  <h4 class="block-icon-title"><a href="notaryandattestation.html">Notary and attestation</a></h4>
...
<a href="notaryandattestation.html">Read More...</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-12">
              ...
              <div class="owl-carousel" data-items="1" data-md-items="2" data-lg-items="3" data-dots="true" data-nav="false" data-stage-padding="15" data-loop="false" data-margin="30" data-mouse-drag="false">
                <div class="post-classic"><a class="post-classic-tag" href="#">Legal</a>
                  <h4 class="post-classic-title"><a href="single-post.html">Can You be Fined with $1600 for Missing a License Plate Decal?</a></h4>
                  ...
                  </ul><a class="post-classic-link" href="single-post.html">+</a>
                </div>
                <div class="post-classic"><a class="post-classic-tag" href="#">Legal</a>
                  <h4 class="post-classic-title"><a href="single-post.html">Questions Answered About the Length of a Personal Injury Claim</a></h4>
                  <div class="post-classic-text">
                ...
                <div class="post-classic"><a class="post-classic-tag" href="#">Legal</a>
                  <h4 class="post-classic-title"><a href="single-post.html">Tips for Managing Workers’ Compensation Claims</a></h4>
                  <div class="post-classic-text">
