  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(images/breadcrumbs-bg.jpg);">
        <div class="container">
          <h4 class="breadcrumbs-custom-title">Real estate</h4>
          ...
          <div class="row row-30">
            <div class="col-md-5 col-lg-4">
              <div class="section-title section-title-left">
                <h2 class="text-capitalize">Reale state</h2>
              </div>
            </div>
            <div class="col-md-7 col-lg-8 pt-md-5">
              <p>Real estate transactions can be complex and involve a number of different parties and considerations. Whether you are buying, selling, or refinancing a home or business, it is important to work with an experienced realtor who can help guide you through the process.

                The realtor's role in this process is to handle negotiations and ensure that all necessary documents are completed and submitted in a timely manner. Additionally, they will provide guidance on related issues such as financing, taxes, and insurance.
                
                We help you in getting your property and own it .
                </p><img src="images/single-service-1-770x274.jpg" alt="" width="770" height="274"/>
              <p></p>
            </div>
          </div>
        </div>
