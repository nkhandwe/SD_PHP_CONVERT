          ...
          <div class="row row-30">
            <div class="col-md-5 col-lg-4">
              <div class="section-title section-title-left">
                <h2 class="text-capitalize">Why We Are the Award-Winning  <span class="text-italic text-primary">Law Firm</span>
                </h2>
              </div>
            </div>
            <div class="col-md-7 col-lg-8 pt-md-5">
              ...
              <div class="row row-30">
                <div class="col-md-10 col-lg-6">
                  ...
                  <article class="progress-linear">
                    <div class="progress-linear-header">
                      <p class="progress-linear-title">Business Law</p><span class="progress-linear-counter">85</span>
                    </div>
                  ...
                  <article class="progress-linear">
                    <div class="progress-linear-header">
                      <p class="progress-linear-title">Civil Litigation</p><span class="progress-linear-counter">70</span>
                    </div>
                    <div class="progress-linear-body">
                      <div class="progress-linear-bar"></div>
                    </div>
                  ...
                  <article class="progress-linear">
                    <div class="progress-linear-header">
                      <p class="progress-linear-title">Family Law</p><span class="progress-linear-counter">90</span>
                    </div>
                    <div class="progress-linear-body">
                      <div class="progress-linear-bar"></div>
                    </div>
                ...
                <div class="col-md-10 col-lg-6">
                  ...
                  <article class="progress-linear">
                    <div class="progress-linear-header">
                      <p class="progress-linear-title">Insurance Service</p><span class="progress-linear-counter">90</span>
                    </div>
                    <div class="progress-linear-body">
                      <div class="progress-linear-bar"></div>
                    </div>
                  ...
                  <article class="progress-linear">
                    <div class="progress-linear-header">
                      <p class="progress-linear-title">Traffic Accidents</p><span class="progress-linear-counter">70</span>
                    </div>
                    <div class="progress-linear-body">
                      <div class="progress-linear-bar"></div>
                    </div>
                  ...
                  <article class="progress-linear">
                    <div class="progress-linear-header">
                      <p class="progress-linear-title">Patent Infringement</p><span class="progress-linear-counter">90</span>
                    </div>
                    <div class="progress-linear-body">
                      <div class="progress-linear-bar"></div>
                    </div>
              ...
              <div class="parallax-content section-md context-dark text-center bg-gray-700-filter-70">
                <div class="container">
                  <div class="row row-30 justify-content-center">
                    <div class="col-12">
                      <div class="section-title">
                        <h2>We Assure You that You Will Win<span class="d-block heading-1 text-italic">No Win. No Fee</span></h2>
                      </div>
                    </div>
                    <div class="col-md-8 col-lg-6">
                      <p>Vitae nunc sed velit dignissim sodales ut eu. Sed vulputate odio ut enim blandit volutpat. Diam in arcu cursus euismod quis viverra nibh cras pulvinar. </p><a class="button button-circle button-primary" href="#">Free Consultation </a>
                    </div>
                  </div>
                </div>
              </div>
